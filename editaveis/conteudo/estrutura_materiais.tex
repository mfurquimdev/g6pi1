...
\section{Piso – Ambiente externo (Molhado)}
...
\centering
%\includegraphics[keepaspectratio,scale=0.8]{figuras/planta1.jpg}
...
\centering
%\includegraphics[keepaspectratio,scale=0.5,angle=90]{figuras/planta2.jpg}
...
\centering
%\includegraphics[keepaspectratio,scale=0.5]{figuras/planta3.png}
