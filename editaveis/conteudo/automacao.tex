...
\begin{enumerate}
	...
	\item Sensor de movimento, iluminação e temperatura
	  \begin{center}
		\includegraphics[keepaspectratio,scale=0.9,angle=90]{figuras/sensor_movimento.eps}
...
%	Referências:
%[1]MONTGOMERY, Lisa. A tendência da tecnologia na visão dos maiores experts. Disponível em <http://revistahometheater.uol.com.br/site/tec_artigos_02.php?id_lista_txt=5542>. Acesso em 23 de setembro de 2015;
%[2] Siqueira, F.  e Fraga J.  Modelo de Programação de Aplicações Tempo-Real em Sistemas Abertos. Disponível em<http://www.inf.ufsc.br/~frank/papers/wasap.pdf>. Acesso em 20 de setembro de 2015;
%[3] Glenn, Brookshear J. Ciência da Computação - Uma Visão Abrangente, 11ed. Disponível em: <https://books.google.com.br/books?id=Vfw4AgAAQBAJ&pg=PA81&lpg=PA81&dq=processamento+em+tempo+real+e+processamento+interativo&source=bl&ots=iyf1pl0q1g&sig=ptl6i2ao9IcgMSMiVtI3Avkmlqw&hl=pt-BR&sa=X&ved=0CBwQ6AEwAGoVChMIqfaq4YGHyAIVyYqQCh0vcgRK#v=onepage&q=processamento%20em%20tempo%20real%20e%20processamento%20interativo&f=false>. Acesso em 20 de setembro de 2015
%[4] Siqueira, F.  e Fraga J. Programação de Aplicações Tempo-Real em Sistemas Abertos: O Modelo Reflexivo Tempo-Real Distribuído. Laboratório de Controle e Microinformática – LCMI.
%Disponível em: <http://www.inf.ufsc.br/~frank/papers/wasap2.pdf>. Acesso em 22 de setembro de 2015.
%[5]CAGNA, Thiago. Como funcionam e quanto custam os sensores de movimento e de luz.< http://ecohospedagem.com/como-funcionam-e-quanto-custam-os-sensores-de-movimento-e-de-luz />. Acesso em 23 de setembro de 2015;
%[6]Texas Instruments. Datasheet LM35. Disponível em <http://www.ti.com/lit/ds/symlink/lm35.pdf>. Acesso em 23 de setembro de 2015

%[7]Manual do usuário. Disponível em: <http://store.homeseer.com/store/HomeSeer-HSM200-Z-Wave-Multi-Sensor-P1882.aspx>. Acesso em: 14 de outubro de 2015.
%[8] JFL Alarmes. Características do sensor infravermelho IRPET-500. Disponível em: <http://jflalarmes.tecnologia.ws/uploads/jfl-download-passivos-irpet-500.pdf>. Acesso em: 15 de outubro de 2015.
%[9]Manual do usuário. Disponível em: <http://store.homeseer.com/store/Everspring-ST814-2-Z-Wave-Temperature-Humidity-Sensor-P1087.aspx>. Acesso em: 14 de outubro de 2015.
%[10]Características do chuveiro inteligente. Disponível em: <http://www.ihouse.com.br/caracteristicas-do-smartshower.php>. Acesso em: 15 de outubro de 2015.
%[11]Manual do usuário. Disponível em: <http://store.homeseer.com/store/First-Alert-ZCOMBO-G-Z-Wave-Smoke-and-Carbon-Monoxide-Detector-P1990.aspx>.  Acesso em: 14 de outubro de 2015.
%[12]Manual do usuário. Disponível em: <http://store.homeseer.com/store/Aeon-Labs-Aeotec-DSB28-ZWUS-Z-Wave-Home-Energy-Meter-2nd-Edition-P1643.aspx>. Acesso em: 14 de outubro de 2015.
%[13]Guia de instalação. Disponível em: <http://store.homeseer.com/store/Foscam-FI8905W-Outdoor-Wireless-IP-Camera-4mm-lens-60-LED-P1100.aspx> . Acesso em: 14 de outubro de 2015.
