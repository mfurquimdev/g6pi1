...
Entre os softwares, tem se um que já abrange um dos primeiros requisitos esperados como por exemplo programas que trabalhando junto com os hardwares que serão implementados  ajudem num período de 24 horas no monitoramento por vídeo da residência, softwares de ativação e controle a iluminação da casa, controle de irrigação, controle de mídia, controle da trava do portão entre outras funções  apresentadas na lista de softwares. 
E os softwares escolhidos abraçam todas as atividades as quais foram destinados, ou seja, eles cumprem com os requisitos pré estabelecidos em escopo para uma melhor automação da casa. Assim o HomeSeer possui todos os critérios e licenças necessárias  para satisfazer o projeto desejado.
