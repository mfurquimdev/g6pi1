...
\@ifclassloaded{coursepaper}
{
  ...
  \def\@maketitle{%
    ...
    %\null
    \begin{center}
    \includegraphics[width=\textwidth]{images/fga.jpg}%  
    \end{center}
...
\setlength\headheight{30pt} %% just to make warning go away. Adjust the value after looking into the warning.
\pagestyle{fancy}
\renewcommand{\headrulewidth}{0pt}
% \chead{\includegraphics[width=16cm]{fga.jpg}}
\lhead{\includegraphics[width=7cm]{unb}}
\rhead{\includegraphics[width=5cm]{fga}}
